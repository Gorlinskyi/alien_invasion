...
def fire_bullet(ai_settings, screen, ship, bullets):
    """
    Выпускает пулю если максиммум ещё не достигнут
    """
...
def check_play_button(ai_settings, screen, stats, play_button, ship, aliens,
    ...
    """Запускает новую игру при нажатии конпки Play"""
...
def update_bullets(ai_settings, screen, ship, aliens, bullets):
    ...
    # удаление пуль вышедших за край верхний экрана
...
def get_number_rows(ai_settings, ship_height, alien_height):
    """Определяет количество раядов, помещающихся на экране"""
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # интервал между соседними пришельцами = одной ширине пришельца
    alien = Alien(ai_settings, screen)
